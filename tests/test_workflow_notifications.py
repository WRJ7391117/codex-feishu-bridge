...
class ReleaseVersionTests(unittest.TestCase):
    def test_release_version_and_build_are_unique(self):
        ...
        self.assertEqual(info["CFBundleShortVersionString"], "1.11.6")
        self.assertEqual(info["CFBundleVersion"], "85")
        readme = (ROOT / "README.md").read_text(encoding="utf-8")
        release_notes = (ROOT / "RELEASE_NOTES.md").read_text(encoding="utf-8")
        self.assertIn("1.11.6 (build 85)", readme)
        self.assertIn("1.11.6 (build 85", release_notes)
