...
版本说明：当前源码和本机构建为 `1.10.1 (build 77)`，支持 `macOS 13` 或更高版本。不得用旧版本或同版本不同构建覆盖。
...
- 点击 Bot 菜单“提示灯”→“我的提示灯” → 查看本人名下提示灯、在线状态、默认灯、当前中继、最后逻辑状态和每灯独立的 Task 白名单；本地连接在 Mac App 中完成，重命名、默认灯、关注 Task 和解绑继续在飞书卡片中完成
