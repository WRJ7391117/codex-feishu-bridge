...
3. After a mutation, verify separately:
   ...
   - for Task-management changes, verify all nine Bot menu Event Keys, including `current_task`, `task_settings`, `sync_desktop`, `sync_desktop_switch`, `task_subscriptions`, and `codex_usage`, then use a disposable authorized-project Task for create/search/archive acceptance; restore archived test data afterward
