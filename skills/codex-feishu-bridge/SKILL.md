...
3. After a mutation, verify separately:
   ...
   - for Task-management changes, verify all three Bot menu Event Keys, then use a disposable authorized-project Task for create/search/archive acceptance; restore archived test data afterward
