...
3. After a mutation, verify separately:
   ...
   - for Task-management changes, verify all six Bot menu Event Keys, including `current_task`, `sync_desktop`, and `codex_usage`, then use a disposable authorized-project Task for create/search/archive acceptance; restore archived test data afterward
